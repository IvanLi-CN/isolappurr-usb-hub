...
- `bun run test:icons` validates the geometry contract and marketing image dimensions: regular icons keep padding, maskable icons stay edge-aligned, desktop PNG assets are not transparent placeholders, and light/dark poster and social preview exports keep their exact required sizes.
