...
- `npx --yes skills add IvanLi-CN/isolappurr-usb-hub --skill isolapurr-user-operations -y`
- 内容边界：使用 release 版 `isolapurr` / `isolapurr-devd` 与正式 Web Serial 路径；不要求源码 checkout、Rust、Bun、Just 或本地构建缓存。
