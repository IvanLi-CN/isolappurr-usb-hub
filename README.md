...
- 下行 USB‑C ×1：使用 **CH224Q + TPS55288 + SW2303**（USB‑PD 受电 + 3.3–21 V 可调输出；PPS/AVS 能力由 SW2303 侧控制），当前唯一硬件方案记录见 `docs/hardware-variants.md`。  
- 电源输入：
...
- `hardware/`  
  - 当前硬件方案产物；网表位于 `hardware/tps-sw/netlist.enet`。  
- `docs/datasheets/`  
