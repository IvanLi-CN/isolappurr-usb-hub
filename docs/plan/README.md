...
| 0009 | Desktop：全平台支持（Windows/Linux） | 部分完成（2/5） | `0009:desktop-cross-platform-support/PLAN.md` | 2026-01-15 | Win/Linux: x86_64+arm64; Windows: msi + portable zip; Linux: deb + portable tar.gz; branch: `feat/0009-desktop-cross-platform-support` |
