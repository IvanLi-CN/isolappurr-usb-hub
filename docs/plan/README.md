...
| 0004 | GitHub Pages Web：双口遥测与控制台（Mock，多设备） | 待实现 | `0004:github-pages-ports-dashboard/PLAN.md` | 2026-01-10 | Mock only（暂不连真机；后续用 PNA） |
| 0005 | 设备 HTTP API：双口遥测 + 端口操作（Web 对接） | 待实现 | `0005:device-http-api/PLAN.md` | 2026-01-10 | CORS allowlist: `https://isolapurr.ivanli.cc` |
