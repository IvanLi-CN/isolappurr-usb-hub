...
| 0015 | Desktop：CI 触发去重（避免 push 与 PR 重复） | 部分完成（2/3） | `0015:desktop-ci-trigger-gating/PLAN.md` | 2026-01-18 | 非主分支 push 不构建 desktop；main/release/tags push 仍构建；fork PR 跳过；branch: `feat/0015-desktop-ci-trigger-gating` |
