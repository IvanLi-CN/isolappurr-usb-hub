...
| tfzd3 | PWA 启动壳与启动恢复 | 已完成 | `tfzd3-pwa-launch-recovery/SPEC.md` | 2026-07-22 | Installed-PWA startup shell, failure recovery shell, proactive prompt-preserving update discovery, GitHub Pages hashed-asset retention window, and `/flash` PWA workbench metadata caching |
