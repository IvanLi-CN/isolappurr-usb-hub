...
| tfzd3 | PWA 启动壳与启动恢复 | 已完成 | `tfzd3-pwa-launch-recovery/SPEC.md` | 2026-07-19 | Installed-PWA startup shell, failure recovery shell, prompt-preserving SW healing, and GitHub Pages hashed-asset retention window |
