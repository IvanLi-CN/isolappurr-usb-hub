...
| 6xrna | CH318T LEDD 上游链路指示与启动恢复 | 部分完成（4/5） | `6xrna-ch318-ledd-upstream-link/SPEC.md` | 2026-05-10 | Migrated from legacy `docs/plan/6xrna:ch318-ledd-raw-signal/PLAN.md`; LEDD integrator and default-off upstream recovery switch |
