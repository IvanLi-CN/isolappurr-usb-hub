...
| u5b2c | USB 通信、固件更新与 Wi-Fi provisioning | 待实现 | `u5b2c-usb-console-provisioning/SPEC.md` | 2026-05-11 | Canonical topic for Web Serial, Desktop native proxy, EEPROM Wi-Fi config, firmware update, and control console |
