...
| --- | --- | --- | --- |
| `tps-sw` | 当前版 | `CH224Q + TPS55288 + SW2303` | `hardware/tps-sw/netlist.enet`；[MCU 资源](mcu-resource-allocation-tps-sw.md) |
| `tps-fusb` | 待设计 | `FUSB302B ×2 + TPS55288`，MCU 实现 PD 3.0 Fixed + PPS | [硬件设计](tps-fusb-hardware-design.md)；[MCU 资源](mcu-resource-allocation-tps-fusb.md)；尚无正式网表 |
...
- `tps-sw` MCU 资源分配：[`docs/mcu-resource-allocation-tps-sw.md`](mcu-resource-allocation-tps-sw.md)
- 含 `SW2303` / `TPS55288` 的设计文档均按 `tps-sw` 方案维护。
- `tps-fusb` 设计入口：[`docs/tps-fusb-hardware-design.md`](tps-fusb-hardware-design.md)
- `tps-fusb` MCU 资源分配：[`docs/mcu-resource-allocation-tps-fusb.md`](mcu-resource-allocation-tps-fusb.md)
