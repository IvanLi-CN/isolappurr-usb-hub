...
适用硬件：`tps-sw`。  
规范基线：`docs/specs/0001-gc9307-normal-ui/SPEC.md`（本文为界面设计与效果图，不替代规格基线）。
...
- 颜色：背景恒为黑；前景色按 `docs/specs/0001-gc9307-normal-ui/SPEC.md` 的“需求（Requirements）/MUST/颜色”（1bpp：每个字符 tile 仅有前景/背景两色）
